...
% Permite quebrar URLs longas
\def\UrlBreaks{\do\/\do-}   % já tens isto na classe, garante que URLs quebram nas barras e traços

% Permite que TeX seja mais flexível em blocos de texto longos
\sloppy

% Configura que listings de código quebrem linhas longas
\usepackage{listings}       % se já estiver, basta

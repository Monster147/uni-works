...
architecture TLAB3_ROM_ARCH of TLAB3_ROM is
...
U1: ASMControl_ROM port map (RESET => RESET, Start => Start, TC => TCDP, MCLK => MCLK, E_M => EnM, E_SD => En_ShiftD, E_SE => En_ShiftE, S_pl => SPL, Sout => SDP, CE => CEASM, RDY => Rdy, Clear => CLEAR, CR => CRASM);

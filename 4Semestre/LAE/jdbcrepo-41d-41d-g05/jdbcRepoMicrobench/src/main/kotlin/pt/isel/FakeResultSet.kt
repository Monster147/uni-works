...
class FakeResultSet(
    ...
    override fun getString(columnLabel: String): String =
        data[cursor][columnLabel]?.toString() ?: throw SQLException("Column $columnLabel is null or missing")
    ...
    override fun getDouble(columnLabel: String?): Double = data[cursor][columnLabel] as Double

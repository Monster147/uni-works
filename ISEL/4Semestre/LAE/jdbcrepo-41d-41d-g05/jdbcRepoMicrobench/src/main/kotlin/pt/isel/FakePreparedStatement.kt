...
class FakePreparedStatement(
    ...
    override fun executeQuery(): ResultSet = FakeResultSet(data)
    ...
    override fun getGeneratedKeys(): ResultSet = FakeResultSet(data)
    ...
    override fun setObject(
        ...
        // No operation needed for fake implementation
    }

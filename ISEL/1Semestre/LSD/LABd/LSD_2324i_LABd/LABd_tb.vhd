...
signal TERMINAL_VALUE_TB, COUNT_VALUE_TB : std_logic_vector(3 downto 0);
...
begin
	...
	UUT: LABd port map(	dataIn 		=> DATA_IN_TB, 
				terminalValue 	=> TERMINAL_VALUE_TB, 
				RESET		=> RESET_TB,
				CLK 		=> CLK_TB, 
				PL 		=> PL_TB, 
				CE 		=> CE_TB, 
...
begin
	...
	-- Incrementa até atingir TC para o valor de contagem 10
	TERMINAL_VALUE_TB <= "1010";
	CE_TB <= '1';
	DATA_IN_TB <= "0110";

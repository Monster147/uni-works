...
class LobbyDetailsScreenTestsNonHost {
    @get:Rule
    ...
    fun setupAppNavHost() = runBlocking {
        ...
        val token = fakeUserService.createToken("bob@gmail.com", "hash")
    ...
    fun confirm_LobbyDetailsScreen_Exists() {
        ...
        composeTestRule.onNodeWithTag(START_MATCH_BUTTON_TAG).assertExists().assertIsNotEnabled()
    }

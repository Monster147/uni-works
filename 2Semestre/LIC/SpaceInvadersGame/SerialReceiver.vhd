...
begin
U1: ShiftRegister port map (data=>SDX, CLK=>SCLK, enableSHIFT=>WRSaida, clear=> Reset, Q=>D);
U2: Comparer port map (A=>"1001", B=>SaidaQ, R=>dFlagSaida);
U3: Comparer port map (A=>"1010", B=>SaidaQ, R=>pFLagSaida);
